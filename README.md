...
This repository provides two notebook versions:

| Notebook | Description |
|:--|:--|
| `Notebooks/BERTidRAAF_Reproducible_BERT_IDF_Benchmark.ipynb` | Main reproducibility notebook intended for re-execution. |
| `Notebooks/BERTidRAAF_Reproducible_BERT_IDF_Benchmark_GPU-H100_executed.ipynb` | Executed benchmark notebook obtained on Google Colab with an H100 GPU runtime. It documents the reported benchmark run and supports the traceability of the exported tables, confidence intervals, and generated figures. |
...
|:------------------|-------------:|---------:|----------:|:----------------|:----------------|
| BERTidRAAF (Ours) |        96.17 |   0.9617 |    0.9805 | 95.58–96.75     | 0.9558–0.9675   |
...
| Model             | Accuracy (%) | Macro-F1 | AUC-macro | Accuracy 95% CI | Macro-F1 95% CI |
|:------------------|-------------:|---------:|----------:|:----------------|:----------------|
| BERTidRAAF (Ours) |        85.71 |   0.8038 |    0.9802 | 82.49–88.84     | 0.7658–0.8324   |
...
│   └── BERTidRAAF_Reproducible_BERT_IDF_Benchmark_GPU-H100_executed.ipynb
├── Figures/
└── Results/
    └── RESULTS_SUMMARY.md
```
